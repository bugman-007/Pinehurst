...
import { Download, MoreHorizontal, Users, Trash, Eye } from "lucide-react";
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            handleDownload(document.file_url, fileName)
                          }
                        >
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(
                              `/dashboard/documents/${document.id}/users`
                            )
                          }
          ...
          <div className="mt-4 max-h-[70vh] overflow-auto">
            {previewDocument && (
              <iframe
                ...
                className="w-full h-[60vh] border rounded bg-black"
                title={
                  previewDocument.file_url.split("/").pop() ||
                  "Document preview"
                }
